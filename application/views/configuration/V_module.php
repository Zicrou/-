                        ...
                        <?php foreach ($all_data as $value): ?>
                            <tr>
                                ...
                                <td class="actions" style="width: 1%; text-align: center; white-space: nowrap">
                                    ...
                                    <?php btn_show_action($value->id_module, 'MODULE'); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#datatable-buttons').managing_ajax({
                ...
                id_form: 'form',
                url_submit: "<?php echo site_url('configuration/C_module/save')?>",
                ...
                url_edit: "<?php echo site_url('configuration/C_module/get_record')?>",
                url_delete: "<?php echo site_url('configuration/C_module/delete')?>",
            });
