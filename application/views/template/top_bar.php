...
<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="" class="logo"><i class="md md-terrain"></i> <span>GESTION ERREURS</span></a>
        </div>
    </div>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    <li class="dropdown hidden-xs">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg">
                            ...
                            <li class="list-group">
                                <!-- list item-->
                                <a href="" class="list-group-item" id="notification_autorisation">
                                    <div class="media">
                                        <div class="media-left">
                                            <em class="fa fa-user-plus fa-2x text-info"></em>
                                        </div>
                                        <div class="media-body clearfix">
                                            <div class="media-heading">Alert</div>
                                            <p class="m-0">
                                                <small>Vous avez <span class="nbr_notification_control"></span> demande(s)</small>
                                            </p>
                                        </div>
                                    </div>
                                </a>
